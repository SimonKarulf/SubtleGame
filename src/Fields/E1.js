...
import { CODE2, CODE3 } from '../Utilities/Constants';
...
const E1 = ({
    ...
    const hasCompletedEvent = enteredCodes.includes(CODE3);
    const hasEvent = roomConfiguration === 3; //Nervath event
    const shouldFight = false;

    const roomTitle = 'Western Altar';
    ...
    if (hasEvent && name === 'nervath') {
    ...
    } else if (hasEvent && name === 'nervath' && hasCompletedEvent) {
        FirstText = 'The room appears to be entirely empty apart from a summoning circle in the middle from candles.. Slowly something starts to shimmer infront of you.';
        ...
        FirstText = 'The room appears to be entirely empty apart from a summoning circle in the middle from candles.. Slowly something starts to shimmer infront of you.';
        SecondText = 'The spirit takes the shape of nervath. You can tell that it is clearly at peace and this person must have his christmas spirit back';
    } else if (hasEvent) {
        FirstText = 'The room appears to be entirely empty apart from a summoning circle in the middle from candles.. Slowly something starts to shimmer infront of you.';
        SecondText = 'Within seconds it takes the form of a flowing spirit in the shape of Nervath. This must be someones christmas spirit! To help free it you must remind it what it loves most about Christmas. Write a message to the Grinch with your answer and see if you can free the spirit!';
    }
     else {
